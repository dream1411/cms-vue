  ...
  <div class="card">
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-toolbar">
        ...
        >
          ...
          <!--end::Export-->
          <!--begin::Add customer-->
          <!-- <router-link to="/complaint/create" class="btn btn-primary">
    ...
    <div class="card-body pt-0">
      <Datatable
        ...
        checkbox-label="id"
      >
        <template v-slot:complainId="{ row: tableData }">
          {{ tableData.complainId }}
        </template>
        ...
        <template v-slot:status="{ row: tableData }">
          <div
            v-if="tableData.currentStatus == 0"
            class="badge badge-light-warning fw-bold"
          >
            รอดำเนินการ
          </div>
          <div
            v-else-if="tableData.currentStatus == 1"
            class="badge badge-light-info fw-bold"
          >
            ระหว่างดำเนินการ
          </div>
          <div
            v-else-if="tableData.currentStatus == 2"
            class="badge badge-light-danger fw-bold"
          >
            ยกเลิกการดำเนินการ
          </div>
          <div v-else class="badge badge-light-success fw-bold">
            ดำเนินการแล้วเสร็จ
          </div>
        </template>
