    ...
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-toolbar">
        ...
        >
          ...
          <!--end::Export-->
          <!--begin::Add customer-->
          <router-link to="/knowledge/create" class="btn btn-primary">
        ...
        <template v-slot:image="{ row: tableData }">
          ...
          >
            <img
              ...
              :src="
                tableData.thumbnailsPath != null
                  ? checkImage(tableData.thumbnailsPath)
        ...
        <template v-slot:actions="{ row: tableData }">
          <div class="dropdown">
            ...
            >
              <li>
                <router-link
                  :to="'/knowledge/manage/' + tableData.id"
                  class="dropdown-item"
                  >แก้ไข</router-link
                >
              </li>
...
export default defineComponent({
  ...
  setup() {
    const tableHeader = ref([
      ...
      {
        columnName: "ประเภทสื่อ",
        columnLabel: "typeFile",
        sortEnabled: true,
      },
      {
    ...
    const deleteTable = (id) => {
      for (let i = 0; i < tableData.value.length; i++) {
        if (tableData.value[i]["id"] === id) {
            ...
            formData.append("name ", "knowledge");
